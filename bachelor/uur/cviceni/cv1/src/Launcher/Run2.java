...
//                System.out.println("\nFirst element class: " + animal.getClass().getSimpleName()));
    ...
    private static void task3() {
        ...
        /*
            Vypis vlozene savce
         */
        System.out.println("Vlozeny savci:");
        list.forEach(animal -> System.out.println(animal.toString()));
//        list.stream().forEach(animal -> System.out.println(animal.toString()));
        System.out.println("\nJmena jen z ABC:");
        ...
        System.out.println("\nJmena jen z ABC a vic jak 3 energie: ");
    ...
    private static void task4() {
        ...
        /*
            Vypis struktury
         */
        System.out.println("Vlozeny ptaci:");
        list.forEach(animal -> System.out.println(animal.toString()));
//        list.stream().forEach(animal -> System.out.println(animal.toString()));
        System.out.println();
...
//        list.stream().forEach(System.out::println);
         ...
         */
        System.out.println("Abecedne serazena: ");
    ...
    private static void task6() {
        ...
        /*
            Vypis strukturu
         */
        System.out.println("Vypsani listu");
        list.forEach(System.out::println);
        System.out.println();
        ...
        /*
            Overeni melke kopie
         */
        System.out.println("Overeni kopie - energie pred vajckama: " + list.get(0).getEnergy());
        list.get(0).layEggs();
        System.out.println("Overeni kopie - energie po vajckach: " + copy.get(0).getEnergy());
